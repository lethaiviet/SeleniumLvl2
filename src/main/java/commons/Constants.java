...
public class Constants {
    ...
    public static final String CACHE_TOTAL_TICKET_IN_NOTE_BEFORE_BOOKING_ON_MY_TICKET = "CACHE_TOTAL_TICKET_IN_NOTE_BEFORE_BOOKING_ON_MY_TICKET";
    public static final String CACHE_TOTAL_TICKET_IN_NOTE_AFTER_BOOKING_ON_MY_TICKET = "CACHE_TOTAL_TICKET_IN_NOTE_AFTER_BOOKING_ON_MY_TICKET";
}
